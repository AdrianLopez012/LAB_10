...
<%@ page import="com.example.lab_10.model.beans.Estadio" %>

<%
    ArrayList<Estadio> lista = (ArrayList<Estadio>) request.getAttribute("listaestadio");
%>
<!DOCTYPE html>
<html lang="en">
    <head>
    ...
    <body>
        ...
        <div class="container mt-5">
            <h2 class="text-dark">Lista Estadios</h2>
            <div class="mb-3">
                <button class="btn btn-primary mb-3" onclick="window.location.href = 'vistas/estadio/registrar_Estadio.jsp';">
                    Nuevo Estadio
                </button><br>
            </div>
                ...
                <table class="table table-striped table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <button class="btn btn-danger btn-sm" onclick="return Eliminacion(<%= estadio.getIdEstadio() %>, '<%= request.getContextPath() %>');">
                                    Borrar
                                </button>
                            </td>
                        </tr>
                        ...
                        %>
                        <tr>
                            <td colspan="7" class="text-center">No hay Estadios disponibles.</td>
                        </tr>
                        <%
                            }
                        %>
            ...
            function Eliminacion(id, contextPath) {
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        form.method = 'post';
                        form.action = contextPath + '/Estadio?action=eliminarEstadio';
