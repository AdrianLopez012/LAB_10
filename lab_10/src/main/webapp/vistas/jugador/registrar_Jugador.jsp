...
<html>
    ...
    <body>
        ...
        <div class="container mt-5">
            <h2 class="mb-4">Nuevo Jugador</h2>
            <form action="${pageContext.request.contextPath}/Jugador?action=registrarJugador" method="post" class="needs-validation" novalidate>
                <div class="form-group">
                    <label for="nombre">Nombre Completo:</label>
                    <input type="text" class="form-control" id="nombre" name="nombre" placeholder="Nombre" maxlength="50" required>
                    <div class="invalid-feedback">Por favor, ingrese el nombre completo del jugador.</div>
                </div>
                <div class="form-group">
                    <label for="edad">Edad:</label>
                    <input type="number" class="form-control" id="edad" name="edad" placeholder="Edad" maxlength="3" required>
                    <div class="invalid-feedback">Por favor, ingrese la edad del jugador.</div>
                </div>
                <div class="form-group">
                    <label for="posicion">Posición:</label>
                    <input type="text" class="form-control" id="posicion" name="posicion" placeholder="Posición" maxlength="65" required>
                    <div class="invalid-feedback">Por favor, ingrese la posición del jugador.</div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="seleccion" name="seleccion" placeholder="Selección Nacional" maxlength="50" required>
                    <div class="invalid-feedback">Por favor, ingrese el nombre de la selección nacional.</div>
                </div>
            ...
            function Confirmacion() {
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        Swal.fire({
                            title: "¡Registrado!",
                            text: "El Jugador ha sido registrado con éxito",
                            icon: "success",
                        }).then(() => {
